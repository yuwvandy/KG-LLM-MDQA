...
from core.model import LLaMA, LLaMAConfig
from core.utils import EmptyInitOnDevice, lazy_load, incremental_save


@torch.no_grad()
def convert_hf_checkpoint(
    *,
    output_dir: Path = Path("checkpoints/lit-llama2/7B-chat"),
    checkpoint_dir: Path = Path("checkpoints/lit-llama2"),
    model_size: str = "7B",
    dtype: str = "float32",
    verify: bool = False,
) -> None:
