...
def meta_weights_for_nano_model(
    *,
    output_dir: Path = Path("checkpoints/lit-llama2"),
    checkpoint_dir: Path = Path("checkpoints/llama2/"),
    model_size: str = "7B-chat",
    dtype: str = "float32",
) -> None:
    ...
    torch.save(combined, output_dir / "lit-llama2.pth")
